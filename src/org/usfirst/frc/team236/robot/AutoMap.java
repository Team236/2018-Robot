...
public class AutoMap {
	...
	public static final PIDParameters TURN_PARAMS45 = new PIDParameters(0.04, 0.00, -0.0001, 1 / 100.0);
	...
	// public static final PIDParameters TURN_PARAMS60 = new PIDParameters(0.0, 0.00, 0.0, 1 / 100.0);
	...
	public static final double SWITCH_CROSS3 = -32; // 24+
	
	public static final double DIST_FENCE = -110; // desired distance is 101
	...
	public static final double DIST_NULL_TERRITORY = -263; // desired distance is 252.5
	
	public static final double DIST_PLATFORM_ZONE = -209.5;
	public static final double DIST_CROSS_FIELD = -209.5; //186 with bump, try 210
	public static final double DIST_PLATFORM_ZONE_TO_NULL_TERRITORY = -37; // 37
	
	public static final double DIST_AUTO_LINE = -150;
	
	public static final double DIST_SCALE_TO_CUBE = 90;
	
	public static final double MM_END_MARGIN1 = 8; // SW cross 3 - margin 1 > 24
	public static final double MM_END_MARGIN2 = 10; //40
	public static final double MM_END_MARGIN3 = 10; //60
